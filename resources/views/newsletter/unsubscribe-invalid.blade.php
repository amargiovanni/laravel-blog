<x-layouts.blog title="{{ __('Invalid Link') }}">
    <div class="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
            ...
            <h1 class="text-3xl font-bold tracking-tight mb-4">
                {{ __('Invalid Unsubscribe Link') }}
            </h1>

            <p class="text-lg text-zinc-600 dark:text-zinc-400 mb-8">
                {{ __('This unsubscribe link is invalid or has expired. If you need to unsubscribe, please use the link from your most recent newsletter email.') }}
            </p>
