        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('restore')
                    ...
                    ->modalDescription('This will create a new revision with the current content, then restore the post to this revision. Are you sure?')
                    ->action(function (Revision $record): void {
                        ...
                        $post->restoreToRevision($record);

                        Notification::make()
                            ->title('Revision restored')
                            ->body("Post has been restored to revision #{$record->revision_number}.")
                            ->success()
                            ->send();
                    }),
